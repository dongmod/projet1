...
@ManagedBean
@RequestScoped
public class TierExiste  implements Validator {

    @EJB
    private TiersFacadeLocal tiersFacade;
    
private static final String TIERS_EXISTE_DEJA = "Ce numero de compte   existe déjà ";
    ...
    public void validate( FacesContext context, UIComponent component, Object value ) throws ValidatorException {
        ...
        try {
            if ( tiersFacade.trouver( numero, login ) != null ) {
                /*
        ...
        new FacesMessage(FacesMessage.SEVERITY_ERROR, TIERS_EXISTE_DEJA, null ) );
    }
